...
function Listings() {
  ...
  return (
    <div className="flex flex-col md:flex-row gap-6 p-4 md:p-6">
      {/* Left Section: Filter */}
      <div className="flex-shrink-0 w-full md:w-1/4 rounded-md shadow-md p-4 bg-indigo-950 text-white">
        <ProductFilter filter={filter} handleFilter={handleFilter} />
      </div>

      {/* Right Section: Product Listings */}
      <div className="bg-indigo-950 text-white w-full rounded-lg shadow-md p-4">
