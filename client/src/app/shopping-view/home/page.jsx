...
//             )
//           }
//           className="absolute top-1/2 left-4 transform -translate-y-1/2 bg-yellow-300"
//         >
...
//             setCurrentSlide((prevSlide) => (prevSlide + 1) % slides.length)
//           }
//           className="absolute top-1/2 right-4 transform -translate-y-1/2 bg-yellow-300"
//         >
...
//                 className="cursor-pointer hover:shadow-lg transition-shadow bg-blue-600"
//               >
//                 <CardContent className="flex flex-col items-center justify-center px-8 py-4 text-white">
//                   <item.icon className="w-20 h-12 mb-4 " />
...
//       <section className="py-10 bg-gray-50">
//         <div className="container mx-auto px-8">
//           <h2 className="text-3xl font-bold text-center">Premium Brands</h2>
//           <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mt-8">
//             {brands.map((item) => (
//               <Card
//                 key={item.id}
//                 onClick={() => handleNavigateToListingPage(item, "brand")}
//                 className="cursor-pointer hover:shadow-lg transition-shadow bg-yellow-300"
//               >
//                 <CardContent className="flex flex-col items-center justify-center px-8 py-4 text-black">
...
const Home = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-900 text-white">
      ...
      {/* Categories Section */}
      <section className="py-10 bg-indigo-900-950">
        <div className="container mx-auto px-8">
          <h2 className="text-3xl font-bold text-center">Shop by Categories</h2>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 mt-8">
            {categoriesWithIcon.map((item) => (
      ...
      <section className="py-10 bg-violet-900-950">
        <div className="container mx-auto px-8">
          <h2 className="text-3xl font-bold text-center text-white">Premium Brands</h2>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mt-8">
            {brands.map((item) => (
              <Card
                key={item.id}
