    ...
    <nav className="flex flex-col mb-3 md:mb-0 md: items-start gap-6 lg:flex-row">
      {shoppingViewHeaderMenuItems.map((menuItem, idx) => (
        <Label
          ...
          className="text-md font-semibold mr-0 hover:bg-white hover:rounded hover:text-black hover:px-2 hover:text-sm hover:py-1 cursor-pointer"
        >
          {menuItem.label}
        </Label>
      ))}
...
const ShoppingHeader = () => {
  return (
    <header className="sticky top-0 z-40 w-full border-b bg-blue-950 text-white">
